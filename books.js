...
function displayGenderBooks () {
    ...
    var url = 'https://www.googleapis.com/books/v1/volumes?q=subject:${select.value}&langRestrict=fr';
...
document.querySelector('.submit').addEventListener('click', displayGenderBooks); 