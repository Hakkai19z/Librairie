...
<body>
  ...
  <h3>KAHIL MOKHTARI X PATTERSON MENDY</h3>
  <h2>Veuillez découvrir notre Bibliothèque de livres !</h2>
  <?php
  ...
  if (isset($_SESSION['utilisateur'])) {
    // User is logged in, display their name instead of login and signup
    ...
    echo '<nav class="navbar">
            <ul>
              <li><a href="view.php">Bibliothèque</a></li>
                <ul>
                  <li><a href="#">Nom: ' . $nom . '</a></li>
                  <li><a href="#">Prénom: ' . $prenom . '</a></li>
  ...
  <div class="card">
    <a href="https://www.instagram.com/kahil_19z/" class="socialContainer containerOne">
    ...
    <a href="https://twitter.com/home?lang=fr" class="socialContainer containerTwo">
    ...
    <a href="https://www.linkedin.com/in/kahil-mokhtari-55aa582aa/" class="socialContainer containerThree">
